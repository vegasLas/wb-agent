...
const steps = [
  {
    ...
    description: 'Авторизуйтесь через Telegram или браузер. Добавьте API-ключ поставщика Wildberries для начала работы.',
  },
  {
  ...
  },
  {
    ...
    description: 'Следите за аналитикой, управляйте рекламой, участвуйте в акциях и масштабируйте бизнес с AI-ассистентом.',
  },
];

<template>
  <div class="space-y-6">
    <!-- Stats Row -->
    <div v-if="showStats" class="grid grid-cols-3 gap-4">
      <Skeleton v-for="i in 3" :key="i" height="4rem" border-radius="0.5rem" />
    </div>
...
const routeConfig: Record<string, { showStats: boolean; skeletonCount: number }> = {

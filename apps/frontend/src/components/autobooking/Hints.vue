    ...
    >
      ...
      <div class="space-y-2">
        ...
        <div class="mt-2 text-sm">
          <span class="text-yellow-600 dark:text-yellow-400">⚠️ Важно:</span>
          Указывайте точное количество товара, чтобы избежать штрафов. Черновик
          нельзя изменить - создайте новый при необходимости корректировки.
        </div>
      </div>
      ...
      <div class="space-y-2">
        ...
        <div class="mt-2 text-sm">
          <span class="text-blue-600 dark:text-blue-400">💡 Система автоматически:</span>
      ...
      <div class="space-y-2">
        ...
        >
          ...
          <li>
            <strong>Выбрать даты:</strong> Каждое автобронирование использует 1 слот
            независимо от количества дат, система бронирует ВСЕ выбранные даты
          </li>
          <li>
            <strong>Выбрать даты (одна):</strong> Использует 1 слот,
            система бронирует ПЕРВУЮ доступную дату из выбранных
          </li>
        </ul>
        <div class="mt-2 text-sm">
          <span class="text-green-600 dark:text-green-400">💰 Экономия:</span>
          "Выбрать даты (одна)" - идеальный выбор, когда вам подходит любая из
          нескольких дат.
        </div>
      </div>
      ...
      <div class="space-y-2">
        ...
        >
          ...
          <li>
            <strong>Баланс:</strong> Проверяйте количество доступных слотов
            автобронирования перед созданием
          </li>
          <li>

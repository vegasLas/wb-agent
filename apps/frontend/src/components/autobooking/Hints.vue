    ...
    >
      ...
      <div class="space-y-2">
        ...
        <div class="mt-2 text-sm">
          <span class="text-yellow-600 dark:text-yellow-400">⚠️ Важно:</span> Указывайте точное
      ...
      <div class="space-y-2">
        ...
        <div class="mt-2 text-sm">
          <span class="text-green-600 dark:text-green-400">💰 Экономия:</span> "Выбрать даты (одна)"
